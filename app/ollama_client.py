...
class OllamaClient(BaseLLMClient):
    ...
    async def chat_completions(self, messages: List[Dict[str, str]], 
        ...
        try:
            ...
            response = requests.post(f"{self.base_url}/api/chat", json=request_body)
...
class DeepSeekClient(BaseLLMClient):
    def __init__(self, model: str, base_url: str = "https://api.deepseek.com", api_key: str = "", **kwargs):
        super().__init__(model)
        self.base_url = base_url
...
class OpenAIClient(BaseLLMClient):
    def __init__(self, model: str, base_url: str = "https://api.openai.com/v1", api_key: str = "", **kwargs):
        super().__init__(model)
        self.base_url = base_url
        self.api_key = api_key
